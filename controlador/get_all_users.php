<?php 
    ...
    if ($elem!=null) {
        foreach ($elem as $lista) {
            ...
            $arreglo["data"][] = array($lista['tCodigo'],$lista['nombre'],$lista['apellido1'],$lista['apellido2'],$lista['codusuario'],$logueado,$lista['nivel'],$lista['cod_equipo'],$lista['estado'],$btn_editar." ".$btn_unblock);
        }
    } else {
