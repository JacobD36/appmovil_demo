        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <h3 class="header smaller lighter green">Registro de Consultas <?php echo $fecha;?></h3>
                    <p></p>
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    ...
    function muestra_dni(dni){
        var dni = dni;

        $.ajax({
            type: "post",
            url: "./controlador/detalle_dni.php",
            data: {
                dni: dni
            },
    ...
    function muestra_lista1(){
        ...
        var table = $('#my-table').DataTable( {
            ...
            "destroy": true,
            "columns": columns,
            "ajax": "controlador/get_lista1.php?cod="+$("#codusuario").val(),
            "deferRender": true,
            "paging": true,
            "language": {
