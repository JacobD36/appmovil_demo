<?php 
    ...
    $res_values = $data->get_res_values();
...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="javascript:void(0)"><h5>Reporte</h5></a>
        </li>
    </ul>
</div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="form-group" id="sel_res">
                            <label class="col-md-3 col-sm-3 col-xs-12 control-label no-padding-right" for="resultado"><h5>Resultado</h5></label>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <select class="col-md-3 col-sm-3 col-xs-12 form-control input-lg" id="resultado">
                                    <?php foreach($res_values as $lista){?>
                                        <option value="<?php if($lista['tTipo']=='TODO'){echo '';}else{echo $lista['tTipo'];}?>" <?php if($lista['tTipo']=='TODO'){echo 'selected';}?>><?php echo $lista['tTipo'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
...
<script>
    $(function () {
        ...
        var usuario  =  <?php echo $filtro;?>;
        mostrar_registros(tipo2,f1,f2,usuario,res);
    });
    ...
    function mostrar_registros(tipo2,f1,f2,usuario,res){
        var columns = [
            { "title":"DNI","width": "11%" },
            { "title":"CELULAR","width": "11%" },
            { "title":"TIPO","width": "11%" },
            { "title":"FECHA","width": "11%" },
            { "title":"RESULTADO","width": "11%" },
            { "title":"MOTIVO","width": "11%" },
            { "title":"USUARIO","width": "11%"},
            { "title":"SCORE","width": "11%"},
            { "title":"ZONA","width": "11%"}
        ];
